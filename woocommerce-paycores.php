            ...
            return '<form action="'.$paycores_adr.'" method="POST" id="paycores_payment_form" target="_top">
                    ...
                    <style>
                        ...
                        <div class="col-pay-12">
                            ...
                            <div class="col-pay-6">
                                <input type="text" class="input-pay" name="paycores_usr_birth" id="paycores_usr_birth" placeholder="1980-01-20" required>
                            </div>
                        </div>
                        ...
                        <div class="col-pay-12">
                            ...
                            <div class="col-pay-6">
                                <input type="text" class="input-pay" name="paycores_usr_numberId" id="paycores_usr_numberId" placeholder="1094000000" required>
                            </div>
                        </div>
